 ...
 * be resolved to canonical CanonicalEntity IDs in the data store.
 */
 ...
 */
type TrustBoundaryType = 'INTERNET' | 'IDENTITY' | 'SERVICE' | 'DATA' | 'EXTERNAL';
 ...
 * Stored as an entity in the `feature_analyses` collection and
 * connected via IMPLEMENTS_FEATURE edges in the graph store.
 */
 ...
 * Stored on the CodeService entity as `serviceDfd`.
 */
 ...
 * Stored on the CodeService entity as `serviceThreatModel`.
 */
