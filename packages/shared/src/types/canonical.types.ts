...
/**
 * DataStore - A database, storage, or data repository
 * Can be either a CloudResource or a logical entity
 */
export interface DataStore extends BaseEntity {
  entityType: 'data_store';
  storeType: 'database' | 'blob_storage' | 'file_storage' | 'cache' | 'queue' | 'other';
  name: string;
  cloudResourceId?: EntityId; // Reference to CloudResource if applicable
  dataClassification?: 'public' | 'internal' | 'confidential' | 'restricted';
