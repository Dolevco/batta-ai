...
The `core` package contains the LLM task runtime used by Batta: tasks, tools, memory
abstractions, planners, and helpers for composing multi-step or multi-agent workflows.

This README summarizes the main concepts and the important classes and modules.
