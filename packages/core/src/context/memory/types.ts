export interface LongTermMemoryConfig {
  /** Logical memory namespace (default: agent_memories) */
  collectionName?: string;
  /** Tenant identifier for memory isolation — required */
  tenantId: string;
  /** Optional session identifier for scoped memory records */
  sessionId?: string;
  /**
   * PostgreSQL connection string for the default Postgres store.
   * Not needed when you pass a custom `store` implementation.
   */
