 ...
 * The consolidation result is applied directly to Qdrant — no user-facing output is generated.
 */
 ...
 *
 * Security note: Input validation is applied to LLM output before writing to Qdrant.
