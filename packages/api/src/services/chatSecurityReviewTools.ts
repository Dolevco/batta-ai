...
import type { SecurityReviewService, FeatureService, AssetService } from '@batta/shared';
import type { GraphProjection, GraphNode, GraphEdge, TableProjection, TableColumn } from '@batta/core';
...
const SecurityReviewCategory: ToolCategory = {
...
class ListSecurityReviewsTool extends TableBaseTool<ListReviewsParams> {
...
class GetSecurityReviewTool extends BaseTool<GetReviewParams> {
...
class GetSecurityReviewSummaryTool extends BaseTool<GetReviewParams> {
...
class ListBusinessFeaturesTool extends TableBaseTool<ListFeaturesParams> {
...
class GetBusinessFeatureTool extends BaseTool<GetFeatureParams> {
...
class GetFeatureDataFlowTool extends GraphBaseTool<GetFeatureParams> {
...
class GetFeatureRelationshipsTool extends GraphBaseTool<GetFeatureRelationshipsParams> {
...
class GetServiceDataFlowTool extends GraphBaseTool<GetServiceParams> {
...
class GetServiceRelationshipsTool extends GraphBaseTool<GetServiceParams> {
  ...
  async execute(p: GetServiceParams): Promise<GraphToolResult> {
    return safeGraph(async () => {
      ...
      if (relGraph.nodes.length === 0) {
        return {
          success: false,
          message: `No relationship data found for service "${id}". Make sure a scan has been run.`,
          error: 'No data',
          graph: EMPTY_GRAPH,
        };
      }
