...
import type { IMCPIntegrationRepository } from '@ai-agent/shared';
import type { 
...
import { MCPClient } from '@ai-agent/core';
...
export class MCPIntegrationController {
  ...
  async listDockerMCPServers(req: Request, res: Response): Promise<void> {
    try {
