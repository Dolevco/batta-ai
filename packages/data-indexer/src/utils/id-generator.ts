...
import { EntityIdGenerator } from '../pipeline/pipeline.types';
import { TenantId } from '@batta/shared';

class DeterministicIdGenerator implements EntityIdGenerator {
  /**
   ...
   * same ID and the graph store upserts instead of creating a duplicate edge.
   */
