 ...
 *
 * Each document is tagged with `documentType` so the data adapter can
 ...
 *  - All documents include tenantId for tenant isolation.
 */

import * as crypto from 'crypto';
import type { CodeService, SemanticDocument, TenantId } from '@batta/shared';
import type { BusinessFeature } from '@batta/shared';
