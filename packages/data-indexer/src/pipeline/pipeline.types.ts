...
export interface DataStoreConsolidationOutput {
  /** New or updated DataStore canonical entities */
  dataStores: CanonicalEntity[];
  /** New relationships emitted (service→store, store→cloud, feature→store) */
  relationships: Relationship[];
  errors: ExtractionError[];
}
