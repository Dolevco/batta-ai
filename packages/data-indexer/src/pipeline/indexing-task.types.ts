 ...
 * Indexing Task Types
 *
 * Defines the task contract used by the in-process indexing pipeline.
 */

import { TenantId, CanonicalEntity, Relationship, Evidence, SemanticDocument } from '@batta/shared';
import { RepositoryHandle } from './pipeline.types';

/**
 * Task types for indexing
 */
...
export enum TaskStage {
  ...
  DATA_STORE_CONSOLIDATION = 'data_store_consolidation', // Promote DFD/static-analysis evidence into DataStore entities
