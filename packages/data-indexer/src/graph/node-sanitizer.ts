...
export class NodeSanitizationError extends Error {
  constructor(
...
export const ServicePrincipalSchema = baseNodeSchema.extend({
  nodeType: z.literal('ServicePrincipal'),
  appId: z.string(),
  servicePrincipalType: z.enum(['Application', 'ManagedIdentity', 'Legacy']),
}) as ZodSchema<ServicePrincipalNode>;
