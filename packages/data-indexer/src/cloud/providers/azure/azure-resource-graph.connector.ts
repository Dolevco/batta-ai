...
import { CloudResource, TenantId, ThreatModelData } from '@batta/shared';
...
export class AzureResourceGraphConnector {
  ...
  private extractThreatModel(resource: AzureResource): ThreatModelData | undefined {
    ...
    this.generateThreats(threatModel, resourceType);
   ...
   */
  private generateThreats(threatModel: ThreatModelData, resourceType: string): void {
