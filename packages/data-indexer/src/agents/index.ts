...
export enum DataIndexerAgentType {
  ...
  WorkItemReview         = 'work-item-review',
}
...
import { WORK_ITEM_REVIEW_AGENT } from './definitions/workItemReviewAgent';

export { createIaCAnalyzerAgentWithRepository } from './definitions/iacAnalyzerAgent';
export { createScriptAnalyzerAgentWithRepository } from './definitions/scriptAnalyzerAgent';
export { WORK_ITEM_REVIEW_AGENT } from './definitions/workItemReviewAgent';
...
export function createDataIndexerRegistry(api: ILLMApiHandler, smallApi?: ILLMApiHandler): DataIndexerAgentRegistry {
  ...
  registry.register(WORK_ITEM_REVIEW_AGENT);
  return registry;
}
