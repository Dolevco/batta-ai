...
import { cacheAuthProvider } from '../services/auth/authConfig';
import { T } from '../theme';
...
export function LoginPage() {
  ...
  if (AUTH_DISABLED) return <Navigate to="/overview" replace />;
        ...
        <div style={styles.card}>
          <div style={styles.header}>
            <div style={styles.logoContainer}>
              <img src="/images/logo.svg" alt="batta-ai" style={{ height: 80, marginBottom: 16 }} />
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        <div style={styles.header}>
          <div style={styles.logoContainer}>
            <img src="/images/logo.svg" alt="batta-ai" style={{ height: 80, marginBottom: 16, filter: 'brightness(0) saturate(100%) invert(55%) sepia(90%) saturate(500%) hue-rotate(345deg) brightness(1.05)' }} />
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', lineHeight: 1 }}>
              <span style={{ fontSize: 24, fontWeight: 700, color: '#141414' }}>
