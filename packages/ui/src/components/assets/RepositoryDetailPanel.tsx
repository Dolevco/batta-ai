...
export function RepositoryDetailPanel({ assetId, isDark, onBack }: RepositoryDetailPanelProps) {
  ...
  const responsibility = asset.responsibility || asset.metadata?.responsibility as string | undefined;
  const repoUrl = asset.link || asset.metadata?.url as string | undefined;
  const defaultBranch = asset.metadata?.defaultBranch as string | undefined || (asset.fullEntity as any)?.defaultBranch;
